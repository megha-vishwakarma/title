...
const Features = () => {
    ...
    return (
        <section id="Features" className="my-[90px] xl:my-[150px]">
            <div className="container mx-auto">
                ...
                {/* feature list */}
                <div className="grid grid-cols-1 lg:gap-[50px] xl:grid-cols-2">
                    {list.map((feature, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                {/* icon image */}
                                <div
                                    className="max-w-[200px] xl:mr-7 xl:max-w-[232px]"
